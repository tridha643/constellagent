...
// Depends on: SwiftUI, UIKit, AppEnvironment, ConstellagentTrustedPairPresentation
        ...
        SettingsCard(title: "About") {
            ...
            Button {
                ...
                settingsAccessoryRow(
                    ...
                    leading: {
                        ConstellagentIcon.image(systemName: "hand.raised")
                    }
                )
            }
...
struct SettingsTrustedComputerCard: View {
    let presentation: ConstellagentTrustedPairPresentation
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 12) {
            HStack(alignment: .top, spacing: 12) {
                HStack(spacing: 10) {
                    ConstellagentIcon.image(systemName: "laptopcomputer", size: 16, weight: .semibold)
                        .foregroundStyle(.secondary)
                ...
                Button(action: onEditName) {
                    ConstellagentIcon.image(systemName: "pencil")
                        .font(AppFont.caption(weight: .semibold))
                        .foregroundStyle(.secondary)
