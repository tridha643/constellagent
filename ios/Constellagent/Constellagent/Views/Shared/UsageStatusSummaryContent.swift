...
// Depends on: SwiftUI, ContextWindowUsage, ConstellagentRateLimitStatus
...
struct UsageStatusSummaryContent: View {
    ...
    init(
        ...
        rateLimitBuckets: [ConstellagentRateLimitBucket],
    ...
    private var rateLimitRows: [ConstellagentRateLimitDisplayRow] {
        ConstellagentRateLimitBucket.visibleDisplayRows(from: rateLimitBuckets)
    }
    ...
    private func rateLimitRow(_ row: ConstellagentRateLimitDisplayRow) -> some View {
    ...
    private func resetLabel(for window: ConstellagentRateLimitWindow) -> String? {
