// FILE: ConstellagentIcon.swift
// Purpose: Resolves Constellagent-specific icons to bundled Central custom assets with SF Symbol fallback.
// Layer: View Utility
// Exports: ConstellagentIcon
// Depends on: SwiftUI, UIKit

import SwiftUI
import UIKit

enum ConstellagentIcon {
    private static let customAssetsBySystemName: [String: String] = [
        ...
        "constellagent.plan-mode": "central-planning",
        "server.rack": "central-server",
        "shift": "central-shift",
        "slider.horizontal.3": "central-settings-slider-three",
        "speedometer": "central-dashboard-fast",
        "constellagent.fork": "central-fork-code",
        "constellagent.git-branch": "git-branch",
...
private let constellagentIconSquareAnchorSymbol = "square"

private struct ConstellagentIconView: View {
    ...
    var body: some View {
        if let assetName = ConstellagentIcon.assetName(for: systemName) {
    ...
    private func customAsset(_ assetName: String) -> some View {
        ...
        if explicitSize != nil {
            ...
            Image(systemName: constellagentIconSquareAnchorSymbol)
                .opacity(0)
