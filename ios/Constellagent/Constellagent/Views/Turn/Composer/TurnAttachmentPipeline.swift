...
// Depends on: SwiftUI, UIKit, ConstellagentImageAttachment
...
enum TurnComposerImageAttachmentState: Codable, Equatable, Sendable {
    case loading
    case ready(ConstellagentImageAttachment)
    case failed
}
...
enum TurnAttachmentPipeline {
    ...
    static func makeAttachment(from sourceData: Data) -> ConstellagentImageAttachment? {
        ...
        return ConstellagentImageAttachment(
