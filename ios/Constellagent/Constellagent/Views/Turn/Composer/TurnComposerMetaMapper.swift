...
// Depends on: ConstellagentModelOption
...
enum TurnComposerMetaMapper {
    ...
    static func orderedModels(from models: [ConstellagentModelOption]) -> [ConstellagentModelOption] {
        let preferredOrder: [String] = [
            "gpt-5.5",
            "gpt-5.4",
            "gpt-5.3-constellagent",
            "gpt-5.2-constellagent",
            "gpt-5.1-constellagent-max",
            "gpt-5.2",
            "gpt-5.1-constellagent-mini",
        ]
    ...
    static func modelTitle(for model: ConstellagentModelOption) -> String {
    ...
    static func modelTitle(forIdentifier identifier: String?, fallback: String? = nil) -> String {
        ...
        case "gpt-5.5":
            return "GPT-5.5"
        case "gpt-5.3-constellagent":
            return "GPT-5.3-Constellagent"
        case "gpt-5.2-constellagent":
            return "GPT-5.2-Constellagent"
        case "gpt-5.1-constellagent-max":
            return "GPT-5.1-Constellagent-Max"
        case "gpt-5.4":
            return "GPT-5.4"
        case "gpt-5.4-mini":
            return "GPT-5.4-Mini"
        case "gpt-5.2":
            return "GPT-5.2"
        case "gpt-5.1-constellagent-mini":
            return "GPT-5.1-Constellagent-Mini"
        default:
