...
//             UIKitMenuButton, ConstellagentWorktreeIcon, ConstellagentIcon, AdaptiveGlassModifier
...
struct TurnComposerCollapsibleContextCluster: View {
    ...
    private var expandToggleButton: some View {
        Button {
            ...
            ConstellagentIcon.image(systemName: "chevron.right", size: toggleChevronSize)
    ...
    private func buildRuntimeMenu() -> UIMenu {
        ...
        let worktreeAction = UIAction(
            title: worktreeTitle,
            image: ConstellagentWorktreeIcon.menuImage(pointSize: 16, weight: .regular),
        ...
        let localAction = UIAction(
            title: "Local",
            image: ConstellagentIcon.menuUIImage(systemName: "laptopcomputer"),
            attributes: .disabled
        ) { _ in }
