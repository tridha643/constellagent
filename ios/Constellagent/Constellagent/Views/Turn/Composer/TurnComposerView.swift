...
struct TurnComposerView: View {
    ...
    let onSelectFileAutocomplete: (ConstellagentFuzzyFileMatch) -> Void
    let onSelectSkillAutocomplete: (ConstellagentSkillMetadata) -> Void
    let onSelectPluginAutocomplete: (ConstellagentPluginMetadata) -> Void
    ...
    private var placeholderText: String {
        isEmptyThread ? "Ask Constellagent anything..." : "Ask for follow-up changes"
    }
...
private struct ComposerPreviewContent: View {
    ...
    private let modelOptions: [ConstellagentModelOption] = [
        ConstellagentModelOption(
            ...
            supportedReasoningEfforts: [
                ConstellagentReasoningEffortOption(reasoningEffort: "low", description: ""),
                ConstellagentReasoningEffortOption(reasoningEffort: "medium", description: ""),
                ConstellagentReasoningEffortOption(reasoningEffort: "high", description: ""),
                ConstellagentReasoningEffortOption(reasoningEffort: "xhigh", description: ""),
            ],
        ...
        ConstellagentModelOption(
            id: "gpt-5.3-constellagent",
            model: "gpt-5.3-constellagent",
            displayName: "GPT-5.3-Constellagent",
            description: "Preview model",
            isDefault: false,
        ...
        ConstellagentModelOption(
            id: "gpt-5.2-constellagent",
            model: "gpt-5.2-constellagent",
            displayName: "GPT-5.2-Constellagent",
            description: "Preview model",
            isDefault: false,
            supportedReasoningEfforts: [
                ConstellagentReasoningEffortOption(reasoningEffort: "medium", description: ""),
        ...
        ConstellagentModelOption(
            id: "gpt-5.1-constellagent-max",
            model: "gpt-5.1-constellagent-max",
            displayName: "GPT-5.1-Constellagent-Max",
            description: "Preview model",
            isDefault: false,
            supportedReasoningEfforts: [
                ConstellagentReasoningEffortOption(reasoningEffort: "medium", description: ""),
        ...
        ConstellagentModelOption(
            id: "gpt-5.1-constellagent-mini",
            model: "gpt-5.1-constellagent-mini",
            displayName: "GPT-5.1-Constellagent-Mini",
            description: "Preview model",
            isDefault: false,
            supportedReasoningEfforts: [
                ConstellagentReasoningEffortOption(reasoningEffort: "low", description: ""),
