...
extension TurnViewModel {
    func refreshGitBranchTargets(constellagent: ConstellagentService, workingDirectory: String?, threadID: String) {
    ...
    func scheduleGitStatusRefresh(constellagent: ConstellagentService, workingDirectory: String?, threadID: String) {
    ...
    func handleSuccessfulPush(
        ...
        constellagent.appendHiddenPushResetMarkers(
            threadId: threadID,
            workingDirectory: workingDirectory,
    ...
    func applyGitBranchTargets(_ result: GitBranchesWithStatusResult) {
        ...
        gitLocalCheckoutPath = ConstellagentThreadStartProjectBinding.normalizedProjectPath(result.localCheckoutPath)
        ...
        if let defaultBranch = result.defaultBranch, !defaultBranch.isEmpty {
            ...
            let localDefaultBranch = constellagentSelectableDefaultBranch(
