...
// Purpose: Self-contained plan-mode question card, independent of ConstellagentService for easy preview.
// Layer: View Component
// Exports: StructuredUserInputCardView
// Depends on: SwiftUI, ConstellagentCollaboration
...
struct StructuredUserInputCardView: View {
    ...
    @ViewBuilder
    private func questionSection(_ question: ConstellagentStructuredUserInputQuestion) -> some View {
    ...
    private func optionRow(_ option: ConstellagentStructuredUserInputOption, questionID: String) -> some View {
        ...
        return Button {
            ...
            HStack(spacing: 10) {
                ...
                if isSelected {
                    ConstellagentIcon.image(systemName: "checkmark")
    ...
    @ViewBuilder
    private func answerField(_ question: ConstellagentStructuredUserInputQuestion) -> some View {
        let binding = Binding(
    ...
    private var currentQuestion: ConstellagentStructuredUserInputQuestion? {
    ...
    private func question(for questionID: String) -> ConstellagentStructuredUserInputQuestion? {
        ...
        HStack(spacing: 10) {
            if currentQuestionIndex > 0 {
                Button {
                    ...
                    HStack(spacing: 4) {
                        ConstellagentIcon.image(systemName: "chevron.left")
    ...
    private func resolvedAnswers(for question: ConstellagentStructuredUserInputQuestion) -> [String]? {
    ...
    private func toggleOptionSelection(
        ...
        question: ConstellagentStructuredUserInputQuestion?
    ) {
...
private struct QuestionSignature: Hashable {
    ...
    nonisolated init(_ question: ConstellagentStructuredUserInputQuestion) {
        self.id = question.id
...
extension ConstellagentStructuredUserInputQuestion {
...
extension ConstellagentStructuredUserInputOption {
...
#Preview("Multiple choice") {
    ScrollView {
        StructuredUserInputCardView(
            questions: [
                ConstellagentStructuredUserInputQuestion(
                    id: "q1",
                    header: "Architecture",
                    ...
                    isSecret: false,
                    options: [
                        ConstellagentStructuredUserInputOption(label: "Async/Await", description: "Modern Swift concurrency with structured tasks"),
                        ConstellagentStructuredUserInputOption(label: "Combine", description: "Reactive streams using Apple's Combine framework"),
                        ConstellagentStructuredUserInputOption(label: "Callbacks", description: "Traditional completion handler pattern"),
                    ]
                )
            ],
            isSubmitting: false,
        ...
        StructuredUserInputCardView(
            questions: [
                ConstellagentStructuredUserInputQuestion(
                    ...
                    isSecret: false,
                    options: [
                        ConstellagentStructuredUserInputOption(label: "AWS", description: "Amazon Web Services EC2/ECS"),
                        ConstellagentStructuredUserInputOption(label: "GCP", description: "Google Cloud Run"),
                        ConstellagentStructuredUserInputOption(label: "Self-hosted", description: "On-premise VPS"),
                    ]
                )
            ],
            isSubmitting: false,
        ...
        StructuredUserInputCardView(
            questions: [
                ConstellagentStructuredUserInputQuestion(
                    ...
                    isSecret: false,
                    options: [
                        ConstellagentStructuredUserInputOption(label: "Yes", description: "Migrate everything at once"),
                        ConstellagentStructuredUserInputOption(label: "No", description: "Only new endpoints for now"),
                    ]
                ),
                ConstellagentStructuredUserInputQuestion(
                    id: "q2",
                ...
                ConstellagentStructuredUserInputQuestion(
                    ...
                    isSecret: false,
                    options: [
                        ConstellagentStructuredUserInputOption(label: "This sprint", description: "2-week delivery window"),
                        ConstellagentStructuredUserInputOption(label: "Next quarter", description: "Phased rollout with buffer"),
                    ]
                ),
            ],
            isSubmitting: false,
        ...
        StructuredUserInputCardView(
            questions: [
                ConstellagentStructuredUserInputQuestion(
                    ...
                    isSecret: false,
                    options: [
                        ConstellagentStructuredUserInputOption(label: "Yes", description: ""),
                        ConstellagentStructuredUserInputOption(label: "No", description: ""),
                    ]
                )
            ],
            isSubmitting: true,
