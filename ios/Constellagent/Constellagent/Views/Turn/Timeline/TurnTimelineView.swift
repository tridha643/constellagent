...
struct TurnTimelineView<EmptyState: View, Composer: View>: View {
    ...
    private var visibleMessages: ArraySlice<ConstellagentMessage> {
    ...
    private func renderItemsCacheSignature(for messages: ArraySlice<ConstellagentMessage>) -> TurnTimelineRenderItemsCacheSignature {
    ...
    private func blockInfoInputKey(for messages: [ConstellagentMessage]) -> Int {
