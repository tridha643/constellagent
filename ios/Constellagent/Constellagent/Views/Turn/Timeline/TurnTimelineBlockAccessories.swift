...
extension TurnTimelineView {
    ...
    static func assistantBlockInfo(
        for messages: [ConstellagentMessage],
        activeTurnID: String?,
        ...
        while i >= 0 {
            ...
            var fileChangeMessages: [ConstellagentMessage] = []
            var blockRevert: (presentation: AssistantRevertPresentation, message: ConstellagentMessage)?
    ...
    private static func shouldEagerlyBuildBlockDiff(for messages: [ConstellagentMessage]) -> Bool {
        var totalBytes = 0
