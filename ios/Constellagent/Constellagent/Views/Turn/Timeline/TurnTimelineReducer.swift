...
// Depends on: ConstellagentMessage
...
enum TurnTimelineReducer {
    ...
    static func project(messages: [ConstellagentMessage]) -> TurnTimelineProjection {
    ...
    static func enforceIntraTurnOrder(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
        ...
        for (_, indices) in indicesByTurn {
            ...
            let sorted: [ConstellagentMessage]
    ...
    private static func hasInterleavedUserFlow(_ turnMessages: [ConstellagentMessage]) -> Bool {
    ...
    private static func hasInterleavedAssistantActivityFlow(_ turnMessages: [ConstellagentMessage]) -> Bool {
    ...
    private static func isPostAssistantStatusActivity(_ message: ConstellagentMessage) -> Bool {
    ...
    private static func movingFileChangesToTurnTail(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
    ...
    private static func isInterleavableSystemActivity(_ message: ConstellagentMessage) -> Bool {
        guard message.role == .system else {
            return false
        }
    ...
    private static func intraTurnPriority(_ message: ConstellagentMessage) -> Int {
        switch message.role {
        case .user:
            return 0
        case .system:
    ...
    private static func intraTurnTieBreak(_ a: ConstellagentMessage, _ b: ConstellagentMessage) -> Bool {
        if a.role == .assistant,
           b.role == .assistant,
           !a.isStreaming,
           !b.isStreaming,
    ...
    private static func removeHiddenSystemMarkers(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
    ...
    static func collapseThinkingMessages(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
    ...
    private static func latestReusableThinkingIndex(
        in messages: [ConstellagentMessage],
        for incoming: ConstellagentMessage
    ) -> Int? {
    ...
    private static func shouldMergeThinkingRows(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
    ...
    private static func hasCompatibleThinkingTurnScope(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
    ...
    private static func hasStableThinkingIdentity(_ message: ConstellagentMessage) -> Bool {
        guard let itemId = normalizedIdentifier(message.itemId) else {
            return false
        }
        return !(itemId.hasPrefix("turn:") && itemId.contains("|kind:\(ConstellagentMessageKind.thinking.rawValue)"))
    }

    // Identifies placeholder-only rows that should be reused instead of stacked.
    private static func isPlaceholderThinkingRow(_ message: ConstellagentMessage) -> Bool {
    ...
    private static func thinkingSnapshotsOverlap(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
    ...
    static func removeDuplicateUserMessages(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
        var result: [ConstellagentMessage] = []
        result.reserveCapacity(messages.count)
    ...
    private static func shouldMergeUserMessages(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
    ...
    private static func mergedUserMessage(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> ConstellagentMessage {
        var merged = previous
    ...
    private static func attachmentSignature(for message: ConstellagentMessage) -> String {
        message.attachments
    ...
    private static func userMessageMetadataLooksCompatible(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
    ...
    static func removeDuplicateAssistantMessages(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
    ...
    private static func shouldMergeExactAssistantReplay(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
    ...
    private static func mergedExactAssistantReplay(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> ConstellagentMessage {
        var merged = previous
    ...
    private static func shouldMergeAssistantReplay(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> Bool {
        guard previous.role == .assistant,
              incoming.role == .assistant,
              previous.threadId == incoming.threadId,
              normalizedIdentifier(previous.turnId) == normalizedIdentifier(incoming.turnId) else {
    ...
    private static func isAssistantBlockReplay(in messages: [ConstellagentMessage], incoming: ConstellagentMessage) -> Bool {
    ...
    static func removeDuplicateFileChangeMessages(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
    ...
    static func removeDuplicateSubagentActionMessages(in messages: [ConstellagentMessage]) -> [ConstellagentMessage] {
        var result: [ConstellagentMessage] = []
        result.reserveCapacity(messages.count)
    ...
    private static func shouldMergeSubagentActionMessages(
        previous: ConstellagentMessage,
        previousAction: ConstellagentSubagentAction,
        incoming: ConstellagentMessage,
        incomingAction: ConstellagentSubagentAction
    ) -> Bool {
    ...
    private static func preferredSubagentActionMessage(previous: ConstellagentMessage, incoming: ConstellagentMessage) -> ConstellagentMessage {
    ...
    private static func duplicateFileChangeKey(for message: ConstellagentMessage) -> String? {
    ...
    private static func fileChangeDedupSignature(for message: ConstellagentMessage) -> FileChangeDedupSignature? {
        guard message.role == .system,
