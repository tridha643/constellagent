...
// Depends on: SwiftUI, TurnTimelineRenderProjection, MessageRow, ConstellagentMessage
...
struct AssistantBlockAccessoryState: Equatable {
    ...
    let blockRevertMessage: ConstellagentMessage?
    ...
    init(
        ...
        blockRevertMessage: ConstellagentMessage?
    ) {
    ...
    private static func blockRevertMessageSignature(_ message: ConstellagentMessage?) -> AssistantBlockRevertMessageSignature? {
...
private struct AssistantBlockRevertMessageSignature: Equatable {
    ...
    let textSignature: ConstellagentMessageTextRenderSignature
