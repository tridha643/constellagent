...
// Depends on: Foundation, SwiftUI, UIKit, ConstellagentImageAttachment, HapticFeedback
...
private enum UserAttachmentThumbnailCache {
    ...
    static func image(for attachment: ConstellagentImageAttachment) -> UIImage? {
    ...
    private static func cacheKey(for attachment: ConstellagentImageAttachment) -> String {
        "\(attachment.id)|\(attachment.thumbnailContentFingerprint.cacheKey)"
    }
}

private struct UserAttachmentThumbnailView: View {
    let attachment: ConstellagentImageAttachment
...
struct UserAttachmentStrip: View {
    ...
    let onTap: (ConstellagentImageAttachment) -> Void
...
enum AttachmentPreviewImageResolver {
    ...
    static func resolve(_ attachment: ConstellagentImageAttachment) -> UIImage? {
