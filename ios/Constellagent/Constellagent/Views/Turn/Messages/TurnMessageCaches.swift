...
// Depends on: Foundation, ConstellagentMessage, TurnMessageRegexCache, TurnFileChangeSummaryParser,
...
enum MessageRowRenderModelCache {
    ...
    static func model(for message: ConstellagentMessage, displayText: String) -> MessageRowRenderModel {
    ...
    private static func buildModel(for message: ConstellagentMessage, displayText: String, sourceText: String) -> MessageRowRenderModel {
        switch message.role {
        case .assistant:
