...
// Depends on: SwiftUI, ConstellagentMessage
...
private struct AssistantRevertActionKey: EnvironmentKey {
    static let defaultValue: ((ConstellagentMessage) -> Void)? = nil
}

extension EnvironmentValues {
    var assistantRevertAction: ((ConstellagentMessage) -> Void)? {
...
private struct SubagentOpenActionKey: EnvironmentKey {
    static let defaultValue: ((ConstellagentSubagentThreadPresentation) -> Void)? = nil
}

extension EnvironmentValues {
    var subagentOpenAction: ((ConstellagentSubagentThreadPresentation) -> Void)? {
