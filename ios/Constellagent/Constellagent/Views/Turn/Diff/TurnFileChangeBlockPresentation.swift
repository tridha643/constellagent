...
// Depends on: Foundation, ConstellagentMessage, TurnFileChangeSummaryParser, TurnDiffLineKind
...
enum FileChangeBlockPresentationBuilder {
    ...
    static func build(from messages: [ConstellagentMessage]) -> FileChangeBlockPresentation? {
    ...
    private static func shouldBuildEagerPresentation(from messages: [ConstellagentMessage]) -> Bool {
        var totalBytes = 0
...
enum FileChangeBlockPresentationCache {
    ...
    static func presentation(from messages: [ConstellagentMessage]) -> FileChangeBlockPresentation? {
