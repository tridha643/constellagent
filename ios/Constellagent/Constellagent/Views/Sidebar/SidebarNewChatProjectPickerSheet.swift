...
// Depends on: SidebarProjectChoice, AppFont, ConstellagentWorktreeIcon
                                    ...
                                    icon: AnyView(
                                        Group {
                                            if choice.iconSystemName == "arrow.triangle.branch" {
                                                ...
                                                ConstellagentIcon.image(systemName: choice.iconSystemName)
                ...
                if showsWithoutProjectOption {
                    Section {
                        Button {
                            ...
                            projectRow(
                                icon: AnyView(
                                    ConstellagentIcon.image(systemName: "bubble.left.and.bubble.right")
                                        .font(AppFont.body(weight: .medium))
                                        .foregroundStyle(.secondary)
                                ),
                                title: "Quick Chat",
...
private enum SidebarNewChatProjectPickerSheetPreviewData {
    static let sampleChoices: [SidebarProjectChoice] = [
        ...
        SidebarProjectChoice(
            ...
            label: "Constellagent",
            iconSystemName: "laptopcomputer",
            projectPath: "/Users/demo/Developer/Constellagent",
            sortDate: Date()
        )
    ]
}
