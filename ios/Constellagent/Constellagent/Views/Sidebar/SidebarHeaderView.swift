...
// Depends on: SwiftUI, UIKit, SidebarToolbarIconButton, ConstellagentIcon,
...
struct SidebarHeaderView: View {
    ...
    private var appLogo: some View {
        ...
        Image("constellagent_symbol_semibold")
            .font(.system(size: 20))
            .foregroundStyle(.primary)
    }
    ...
    private var overflowMenuButton: some View {
        ...
        // through `ConstellagentIcon.menuUIImage` at the SF Symbol menu glyph
    ...
    private func overflowAction(
        ...
        UIAction(
            title: title,
            image: ConstellagentIcon.menuUIImage(systemName: systemName),
