...
// Depends on: SwiftUI, ConstellagentConnectionPhase, ConstellagentTrustedPairPresentation,
//             AppFont
...
struct SidebarConnectionEmptyStatePanel: View {
    ...
    let trustedPairPresentation: ConstellagentTrustedPairPresentation?
    ...
    private var heroIcon: some View {
        ZStack {
            ...
            ConstellagentIcon.image(systemName: heroIconName, size: 28, weight: .regular)
...
#Preview("Offline — reconnect candidate") {
    SidebarConnectionEmptyStatePanel(
        connectionPhase: .offline,
        trustedPairPresentation: ConstellagentTrustedPairPresentation(
            deviceId: "abc",
