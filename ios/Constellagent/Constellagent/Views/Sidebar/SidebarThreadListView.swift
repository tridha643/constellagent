...
struct SidebarThreadListView: View {
    ...
    let timingLabelProvider: (ConstellagentThread) -> String?
    var showsTimestampRefreshIndicator: (ConstellagentThread) -> Bool = { _ in false }
    let runBadgeStateByThreadID: [String: ConstellagentThreadRunBadgeState]
    let onSelectThread: (ConstellagentThread) -> Void
    ...
    var onRenameThread: ((ConstellagentThread, String) -> Void)? = nil
    var onPinToggleThread: ((ConstellagentThread) -> Void)? = nil
    var onArchiveToggleThread: ((ConstellagentThread) -> Void)? = nil
    var onDeleteThread: ((ConstellagentThread) -> Void)? = nil
    ...
    var body: some View {
        ...
        .task(id: visibleSubagentThreadIDs) {
            await constellagent.loadSubagentThreadMetadataIfNeeded(threadIds: visibleSubagentThreadIDs)
        }
        .onAppear {
    ...
    private func threadRow(
        ...
        return SidebarThreadRowView(
            ...
            isPinned: constellagent.isThreadPinned(thread.id),
    ...
    private func collectVisibleSubagentThreadIDs(
        from thread: ConstellagentThread,
        childrenByParentID: [String: [ConstellagentThread]],
        ancestorThreadIDs: Set<String>,
    ...
    private func subagentAncestorIDs(for thread: ConstellagentThread) -> Set<String> {
...
private enum SidebarThreadListPreviewFixtures {
    ...
    static let pinnedThread = ConstellagentThread(
        id: "pinned-1",
    ...
    static let omnaraThreads: [ConstellagentThread] = [
        ConstellagentThread(id: "om-1", title: "Create Landing Page with AI Stuff", createdAt: ago(180), updatedAt: ago(2), cwd: "/Users/dev/omnara-voice"),
        ConstellagentThread(id: "om-2", title: "Create Landing Page with AI Stuff", createdAt: ago(170), updatedAt: ago(2), cwd: "/Users/dev/omnara-voice"),
        ConstellagentThread(id: "om-3", title: "Landing Page", createdAt: ago(160), updatedAt: ago(2), cwd: "/Users/dev/omnara-voice"),
        ConstellagentThread(id: "om-4", title: "App's UI", createdAt: ago(150), updatedAt: ago(2), cwd: "/Users/dev/omnara-voice"),
        ConstellagentThread(id: "om-5", title: "Backend", createdAt: ago(140), updatedAt: ago(2), cwd: "/Users/dev/omnara-voice"),
    ]

    static let bridgeThreads: [ConstellagentThread] = [
        ConstellagentThread(id: "br-1", title: "Investigate flaky tests", createdAt: ago(800), updatedAt: ago(8), cwd: "/Users/dev/phodex-bridge"),
        ConstellagentThread(id: "br-2", title: "Refactor relay session store", createdAt: ago(900), updatedAt: ago(45), cwd: "/Users/dev/phodex-bridge"),
        ConstellagentThread(id: "br-3", title: "Wire QR pairing flow", createdAt: ago(1500), updatedAt: ago(220), cwd: "/Users/dev/phodex-bridge"),
    ]
