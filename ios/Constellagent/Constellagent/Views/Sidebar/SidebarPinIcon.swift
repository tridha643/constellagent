...
// Depends on: SwiftUI, ConstellagentIcon, AppFont, SidebarForegroundStyle
...
struct SidebarPinIcon: View {
    ...
    var body: some View {
        ...
        // map to `central-pin` in `ConstellagentIcon`.
        ConstellagentIcon.image(systemName: "pin", size: 18, weight: .medium)
