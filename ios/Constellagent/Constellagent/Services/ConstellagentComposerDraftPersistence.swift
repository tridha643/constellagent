// FILE: ConstellagentComposerDraftPersistence.swift
// Purpose: Persists unsent per-thread composer drafts, including local image payloads.
// Layer: Service Persistence
// Exports: ConstellagentComposerDraftPersistence
// Depends on: Foundation, CryptoKit, SecureStore, TurnComposerLocalDraft

import CryptoKit
import Foundation

nonisolated struct ConstellagentComposerDraftPersistence {
    private let fileName = "constellagent-composer-drafts-v1.bin"
