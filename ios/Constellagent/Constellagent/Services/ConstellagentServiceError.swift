// FILE: ConstellagentServiceError.swift
// Purpose: Error taxonomy used by ConstellagentService operations.
// Layer: Service
// Exports: ConstellagentServiceError
// Depends on: RPCError

import Foundation

enum ConstellagentServiceError: LocalizedError {
