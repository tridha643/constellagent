...
enum AppEnvironment {
    ...
    static let privacyPolicyURL = URL(
        string: "https://github.com/Emanuele-web04/constellagent/blob/main/Legal/PRIVACY_POLICY.md"
    )!
    static let termsOfUseURL = URL(
        string: "https://github.com/Emanuele-web04/constellagent/blob/main/Legal/TERMS_OF_USE.md"
    )!
    ...
    static func feedbackMailtoURL(
        ...
        var queryItems = [
            URLQueryItem(name: "subject", value: "Share Feedback on Constellagent with the Developer")
        ]
...
private extension AppEnvironment {
    ...
    static func feedbackBody(
        ...
        var lines = [
            "I hit this Constellagent error:",
            "",
            "Error:",
        ...
        if let cliVersion = sanitizedCLIVersion(cliVersion) {
            lines.append("- Constellagent CLI: \(cliVersion)")
        }
        lines.append("")
        lines.append("Notes:")
