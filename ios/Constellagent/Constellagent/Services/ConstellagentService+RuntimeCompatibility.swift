// FILE: ConstellagentService+RuntimeCompatibility.swift
// Purpose: Centralizes app-server compatibility fallbacks that can be learned per bridge session.
// Layer: Service
// Exports: ConstellagentService runtime compatibility helpers
...
private extension ConstellagentService {
    var serviceTierBridgeUpdatePrompt: ConstellagentBridgeUpdatePrompt {
        ConstellagentBridgeUpdatePrompt(
            title: "Update Constellagent on your device to use Speed controls",
            message: "This device bridge does not support the selected speed setting yet. Update the Constellagent npm package to use Fast Mode and other speed controls.",
