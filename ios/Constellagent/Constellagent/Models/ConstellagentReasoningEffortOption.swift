// FILE: ConstellagentReasoningEffortOption.swift
// Purpose: Represents one reasoning effort option for a runtime model.
// Layer: Model
// Exports: ConstellagentReasoningEffortOption
// Depends on: Foundation

import Foundation

struct ConstellagentReasoningEffortOption: Identifiable, Codable, Hashable, Sendable {
