...
enum AppFont {
    ...
    static var storageKey: String { "constellagent.appFontStyle" }
    static var legacyStorageKey: String { "constellagent.useJetBrainsMono" }
...
enum UserBubbleColor: String, CaseIterable, Identifiable {
    ...
    static var storageKey: String { "constellagent.userBubbleColor" }
    ...
    var menuSwatchImage: UIImage {
        ...
        let image = ConstellagentIcon.uiImage(systemName: "circle.fill", withConfiguration: configuration) ?? UIImage()
