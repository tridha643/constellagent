// FILE: ConstellagentMessageOrderCounter.swift
// Purpose: Thread-safe monotonically increasing counter for message ordering.
// Layer: Model
// Exports: ConstellagentMessageOrderCounter
// Depends on: Foundation

import Foundation
import os

/// Provides a globally unique, monotonically increasing order index for ConstellagentMessage.
...
nonisolated enum ConstellagentMessageOrderCounter {
    ...
    static func seed(from allMessages: [String: [ConstellagentMessage]]) {
