...
final class TurnTimelineReducerTests: XCTestCase {
    ...
    func testDeduplicatesStalePendingImagePromptWhenConfirmedEchoUsesDifferentAttachmentIdentity() {
        let threadID = "thread"
        let now = Date()
        let pendingAttachment = ConstellagentImageAttachment(
            id: "pending-image",
            thumbnailBase64JPEG: "local-thumb",
            payloadDataURL: "data:image/jpeg;base64,LOCAL"
        )
        let confirmedAttachment = ConstellagentImageAttachment(
            id: "confirmed-image",
    ...
    func testTimelineProjectionKeepsPreviousMessagesChronologicalForMultiAssistantTurns() {
        ...
        let rawMessages = [
            ...
            makeMessage(
                ...
                threadID: "thread",
                role: .assistant,
                text: "The latest Constellagent TestFlight inbox email says: Version 1.4, build 126.",
                createdAt: now.addingTimeInterval(3),
                turnID: "turn-1",
                itemID: "final-item-a",
                orderIndex: 4
    ...
    func testTimelineProjectionSkipsFinalReplaysAndMergedImageArtifactsInPreviousMessages() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                threadID: "thread",
                role: .assistant,
                text: "The site is for Constellagent: an iPhone bridge with a local-first power-user tone.",
                createdAt: now.addingTimeInterval(2),
                turnID: "turn-1",
                orderIndex: 3
            ),
    ...
    func testTimelineProjectionMergesAdjacentSameFileChangeRows() {
        ...
        let messages = [
            makeMessage(
                ...
                Path: Constellagent/Constellagent/Views/Turn/TurnTimelineView.swift
                Kind: update
                Totals: +6 -0
                """,
                createdAt: now,
        ...
        XCTAssertEqual(summary?.entries.first?.path, "Constellagent/Constellagent/Views/Turn/TurnTimelineView.swift")
    ...
    func testRemoveDuplicateAssistantMessagesCollapsesLateReplaySubsetForSameTurn() {
        ...
        Latest TestFlight version: Constellagent 1.4 (122) for iOS.
        """
        let replayText = "Latest TestFlight version: Constellagent 1.4 (122) for iOS."
        let messages = [
            makeMessage(
                id: "assistant-final",
                threadID: "thread",
    ...
    func testRemoveDuplicateAssistantMessagesDropsLongExactTerminalReplayWithStableItem() {
        ...
        Constellagent version 1.4, build 124

        Subject: "Constellagent - Remote AI Coding 1.4 (124) for iOS is now available to test."
        """
    ...
    func testProjectOrdersLateStatusBeforeFinalUsingCreatedAt() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                role: .assistant,
                kind: .chat,
                text: "Latest TestFlight inbox email says: Constellagent version 1.4, build 124.",
                createdAt: now.addingTimeInterval(2),
                turnID: "turn-1",
                itemID: "item-final",
                orderIndex: 2
    ...
    func testRemoveDuplicateFileChangeMessagesDedupesSingleFileRowsAcrossPathRepresentations() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                Path: Constellagent/Constellagent/Views/Turn/TurnToolbarContent.swift
                Kind: update
                Totals: +2 -13
                """,
                createdAt: now.addingTimeInterval(1),
    ...
    func testRenderItemsCacheReusesProjectionForSameSignature() {
        ...
        let projector: ([ConstellagentMessage], Set<String>) -> [TurnTimelineRenderItem] = { source, _ in
            projectionCount += 1
    ...
    func testAssistantBlockInfoDeduplicatesEquivalentSingleFileDiffSnapshots() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                Path: /Users/emanueledipietro/Developer/Constellagent/Constellagent/Constellagent/Views/Turn/TurnMessageComponents.swift
                Kind: update
                Totals: +1 -0
            ...
            makeMessage(
                ...
                Path: Constellagent/Constellagent/Views/Turn/TurnMessageComponents.swift
                Kind: update
                Totals: +1 -0
        ...
        XCTAssertEqual(
            ...
            "Constellagent/Constellagent/Views/Turn/TurnMessageComponents.swift"
        )
    ...
    func testAssistantBlockInfoDoesNotDoubleCountIdenticalSummaryOnlySnapshots() {
        ...
        let messages = [
            ...
            makeMessage(
                ...
                Path: /Users/emanueledipietro/Developer/Constellagent/Sources/App.swift
                Kind: update
                Totals: +2 -1
                """,
                createdAt: now.addingTimeInterval(2),
    ...
    private func makeMessage(
        ...
        var message = ConstellagentMessage(
            id: id,
            threadId: threadID,
            role: role,
            kind: kind,
