...
console.log('3. Verify the model investigates first, then asks a strong initial askUserQuestion round before drafting the plan.')
...
console.log('7. Verify the saved plan uses ## Open Questions / Assumptions, ## Phases, and ## Recommendation.')
...
console.log('12. Verify the saved clarification context includes explicit option mappings like A/1 and B/2 so details such as "A then B" stay grounded.')
console.log('13. Verify read-only help commands remain usable while plan mode is active.')
console.log('14. Verify the saved plan includes every intended phase, not just Phase 1.')
console.log('15. Verify Constellagent can open the newest plan directly from ~/.pi-constell/plans via the Plans button or plan palette, rendering every phase while hiding YAML frontmatter in preview.')
console.log('16. Verify the saved plan covers the required constraints and validation details without becoming overly verbose or repetitive.')
