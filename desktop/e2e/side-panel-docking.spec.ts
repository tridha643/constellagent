...
test.describe('side panel docking', () => {
  test('supports docking supported panels in both directions', async () => {
    ...
    try {
      ...
      expect(sidePanels.right.panelOrder).toEqual(['changes', 'browser', 'sideChat'])
      ...
      expect(sidePanels.right.panelOrder).toEqual(['changes', 'browser', 'sideChat', 'project'])
  ...
  test('restores docked panels after dropping into a collapsed sidebar edge and restarting', async () => {
    ...
    try {
      ...
      expect(persisted.sidePanels.right.panelOrder).toEqual(['files', 'browser', 'sideChat'])
    } finally {
