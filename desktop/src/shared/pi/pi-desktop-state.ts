...
export interface SessionExtensionTuiCustomRecord {
...
export interface SessionExtensionUiStateRecord {
  ...
  /** Active `ctx.ui.custom()` headless TUI (e.g. askUserQuestion). */
  readonly tuiCustom?: SessionExtensionTuiCustomRecord;
}
