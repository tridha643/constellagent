...
const DEFAULT_THEME: AppearanceThemePreset = {
  ...
  monacoTheme: {
    ...
    colors: {
      ...
      'diffEditor.insertedTextBackground': 'rgba(163, 190, 140, 0.16)',
      'diffEditor.removedTextBackground': 'rgba(191, 97, 106, 0.16)',
    },
  },
...
const ABSOLUTELY_THEME: AppearanceThemePreset = {
  ...
  monacoTheme: {
    ...
    colors: {
      ...
      'diffEditor.insertedTextBackground': 'rgba(0, 200, 83, 0.18)',
      'diffEditor.removedTextBackground': 'rgba(255, 95, 56, 0.18)',
    },
  },
  mermaidThemeVariables: {
    primaryColor: '#cc7d5e',
