...
export const darkTheme = EditorView.theme({
  ".cm-content": {
    ...
    "--pm-inline-code-background-color": "color-mix(in oklch, oklch(72% 0.02 257) 11%, transparent)",
...
export const lightTheme = EditorView.theme({
  ".cm-content": {
    ...
    "--pm-inline-code-background-color": "color-mix(in oklch, oklch(37% 0.04 257) 9%, transparent)",
