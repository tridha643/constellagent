...
/** Landscape-in-frame — attach images (composer). */
export function ImageGalleryIcon() {
  return (
    <Icon>
      <rect x="2.75" y="4.25" width="14.5" height="11.5" rx="2" stroke="currentColor" strokeWidth="1.45" />
      <circle cx="7.25" cy="7.85" r="1.15" fill="currentColor" />
      <path
        d="M3.9 14.35 7.9 10.4l2.15 2.1L16.1 6.45"
        stroke="currentColor"
        strokeLinecap="round"
...
/** Thin upward chevron for circular send (ChatGPT-style). */
