  ...
  return (
    ...
    >
      ...
      {isTranscriptLoading ? (
        ...
        <div className="timeline" data-testid="transcript">
          {/* Icon + title + hint, matching the structured empty-state pattern
              used in Automations/Linear rather than a bare line of text. */}
          <div
            className="timeline-empty"
            style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 6, textAlign: "center", padding: "32px 16px" }}
          >
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" aria-hidden="true" style={{ opacity: 0.5, marginBottom: 2 }}>
              <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
            </svg>
            <div style={{ fontWeight: 600, color: "var(--text-secondary)" }}>Start the conversation</div>
            <div style={{ fontSize: "var(--text-sm)", color: "var(--text-tertiary)" }}>Send a prompt below to begin the session.</div>
          </div>
        </div>
      ) : shouldVirtualize ? (
