...
- Invoke the **imagegen** skill or raster image tools for diagrams, charts, architecture, or plans
...
- Do **not** write plan files under `.codex/plans/` or elsewhere
